...
extern int enzyme_out; // label for arguements whose derivate should be calculated
extern int enzyme_const; // label for arguements whose derivate should not be calculated
